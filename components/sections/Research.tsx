        ...
        <div className="space-y-8">
          {publications.map((pub) => (
            <Reveal key={pub.title}>
              <article className="card-shadow overflow-hidden rounded-lg border border-hairline bg-surface">
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2 border-b border-hairline px-6 py-3.5 md:px-9">
                  ...
                  <span className="rounded-full border border-hairline bg-paper-2 px-2.5 py-1 font-mono text-[0.65rem] text-ink-2">
                    {pub.status}
                  </span>
                </div>
                ...
                <div className="grid gap-8 px-6 py-8 md:grid-cols-12 md:gap-10 md:px-9 md:py-10">
                  <div className="md:col-span-5">
                    <h3 className="serif text-[length:var(--text-title)] leading-[1.12] balance">
                      {pub.title}
                    </h3>
                  ...
                  <div className="md:col-span-7">
                    ...
                    <p className="text-[0.9rem] leading-[1.75] text-ink-2 pretty">{pub.abstract}</p>
                  </div>
                </div>
              </article>
            </Reveal>
